...
export default function Sidebar({ sidebarOpen, setSidebarOpen, AVAILABLE_MODELS, selectedModel, setSelectedModel, currentImage }){
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <button
                            ...
                            className="py-2 px-3 bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 rounded-xl text-xs font-medium transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs"
                       >
                            <FileImageIcon className="w-4 h-4 text-[#F69220]" /> Select File
                       </button>
                       <button
